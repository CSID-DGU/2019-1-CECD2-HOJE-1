...
combine_tessdata -u ./tesseract/tessdata/kor.traineddata \
 	./${ns_font_name}_output/kor
combine_tessdata -o ./fonts_train/kor/kor.traineddata \
	./${ns_font_name}_output/kor.config

#lstm 학습실행
lstmtraining \
  	--model_output ./${ns_font_name}_output/result \
  	--continue_from ./${ns_font_name}_output/kor.lstm \
  	--old_traineddata ./tesseract/tessdata/kor.traineddata \
  	--traineddata ./fonts_train/kor/kor.traineddata \
  	--train_listfile ./fonts_eval/kor.training_files.txt \
  	--debug_interval 0 \
...
lstmtraining \
	...
	--old_traineddata ./tesseract/tessdata/kor.traineddata \
  	--traineddata ./fonts_train/kor/kor.traineddata \
  	--model_output ./${ns_font_name}_output/kor_font_fine.traineddata

cp ./${ns_font_name}_output/kor_font_fine.traineddata ./tesseract/tessdata/
